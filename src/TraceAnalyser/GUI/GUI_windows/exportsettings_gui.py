...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.export_mode.setItemText(4, _translate("Form", "OriginLab (.opju)"))
        self.export_mode.setItemText(5, _translate("Form", "JSON Dataset (.json)"))
        self.export_mode.setItemText(6, _translate("Form", "ML Dataset"))
        self.export_mode.setItemText(7, _translate("Form", "Export Trace Summary"))
