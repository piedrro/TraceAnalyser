...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_5.addWidget(self.show_bleach_range, 1, 0, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.show_measurement_range, 0, 1, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.show_gamma_range, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.crop_reset_active, 1, 1, 1, 1)
        self.crop_reset_all = QtWidgets.QPushButton(Form)
        self.crop_reset_all.setObjectName("crop_reset_all")
        self.gridLayout.addWidget(self.crop_reset_all, 1, 2, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.show_crop_range.setText(_translate("Form", "Crop Ranges"))
        self.show_bleach_range.setText(_translate("Form", "Bleach Ranges"))
        self.show_measurement_range.setText(_translate("Form", "Measurement Ranges"))
        self.show_gamma_range.setText(_translate("Form", "Gamma Ranges"))
