...
import statistics
from TraceAnalyser.simulation.deepgapseq_trace_generator import trace_generator
import matplotlib.pyplot as plt
...
class DeepLasiWrapper():
    ...
    def initialise_models(self, n_colors=""):
        ...
        model_directory = resources.files(importlib.import_module(f'TraceAnalyser.DeepLASI'))
